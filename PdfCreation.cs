...
namespace Ashwell_Maintenance
{
    public static class PdfCreation
    {
        public static void CreateServiceRecordPDF(string site,
            string location,string assetNo,string ApplianceNumber,string ApplianceDetails,string Model,string SerialNumber,string GCNumber,
            string years, string badgetInput, string badgetOutput, string Make,string burnerModel, string BurnerSerialNumber, string type,
            string Spec
          )
        {
            ...
            //Appliance number
            gfx.DrawString("1234", font, XBrushes.Black, new XRect(76, 128, 111 - 76, 139 - 128), XStringFormats.Center);
